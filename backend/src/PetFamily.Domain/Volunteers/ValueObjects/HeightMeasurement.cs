...
public record HeightMeasurement
{
    ...
    private HeightMeasurement(uint centimeters)
    {
    ...
    public static Result<HeightMeasurement, Error> CreateFromCentimeters(uint centimeters)
    {
    ...
    public static Result<HeightMeasurement, Error> CreateFromInches(uint inches)
    {
